...
function navigateToEdit(): void {
  ...
  } else if (props.kind === 'workflow') {
    router.push({ name: 'meta-workflows-edit', params: { name: metaObject.name } });
  } else {
...
function navigateToAdd(): void {
  if (props.kind === 'menu') {
    ...
    router.push({ name: 'meta-workflows-add', params: { kind: props.kind } });
  } else {
...
function navigateToCopy(): void {
  ...
  if (props.kind === 'menu') {
    ...
    router.push({ name: 'meta-workflows-copy', params: { name: metaObject.name } });
  } else {
